            ...
            <div class="card-body">
                <form action="{{ url(str_replace('/edit', '', Request::url())) }}" method="POST"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input value="{{ $data->date, old('date') }}" type="text"
                    ...
                    <div class="mb-3 row">
                        <label for="photo" class="col-sm-2 col-form-label">Gambar baru</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control @error('isi') is-invalid @enderror" id="summernote" name="isi" placeholder="Isi">{{ $data->desc, old('isi') }}</textarea>
                            @error('isi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
