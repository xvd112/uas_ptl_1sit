            ...
            <div class="card-body">
                <form action="{{ url(str_replace('/create', '', Request::url())) }}" method="POST"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input value="{{ date('Y-m-d'), old('date') }}" type="date"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control @error('isi') is-invalid @enderror" id="isi" name="isi" placeholder="Isi">{{ old('isi') }}</textarea>
                            @error('isi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
