...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/dashboard" class="brand-link">
        <img src="{{ asset('asset/img/icon.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
    ...
    <div class="sidebar">
       ...
       with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="/dashboard/daftardokter"
                        class="nav-link {{ Request::is('dashboard/daftardokter*') ? 'active' : '' }}">
