    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
            <div class="col-lg-6">
                ...
                <img src="{{ asset('asset_landing/assets/img/about.jpg') }}" class="img-fluid rounded-4 mb-4"
                    alt="">
            ...
            <div class="col-lg-6">
                <div class="content ps-0 ps-lg-5">
                    ...
                    <div class="position-relative mt-4">
                        <img src="{{ asset('asset_landing/assets/img/about-2.jpg') }}" class="img-fluid rounded-4"
                            alt="">
